...
public class PlayerKillKeepAttackMidgard : PlayerKillKeepAttackAny
{
    private const string questTitle = "[Daily] Property Reclamation (Midgard)";
    ...
    {
        get => "PlayerKillKeepAttackMidgard";
        set { ; }
    }
}