...
public class PlayerKillKeepDefenseHibernia : PlayerKillKeepDefenseAny
{
    private const string questTitle = "[Daily] Stalwart Defender (Hibernia)";

    private new int rewardAmount = 500;
    ...
    {
        get => "PlayerKillKeepDefenseHibernia";
        set { ; }
    }
}