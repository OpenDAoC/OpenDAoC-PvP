...
public class PlayerKillKeepDefenseAlbion : PlayerKillKeepDefenseAny
{
    private const string questTitle = "[Daily] Stalwart Defender (Albion)";
    ...
    {
        get => "PlayerKillKeepDefenseAlbion";
        set { ; }
    }
}