...
public class PlayerKillKeepDefenseMidgard : PlayerKillKeepDefenseAny
{
    private const string questTitle = "[Daily] Stalwart Defender (Midgard)";
    ...
    {
        get => "PlayerKillKeepDefenseMidgard";
        set { ; }
    }
}