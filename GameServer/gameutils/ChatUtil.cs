        ...
        public static void SendTypeMessage(string type, GamePlayer target, string translationID, params object[] args)
        {
            ...
            switch (type)
            {
                ...
                case "centerSys": // Center screen and system window
                    ...
                    break;
                case "chat": // Chat channel messages
                ...
                case "dialogWarn": // Incorrect outputs or problems with command syntax
                    ...
                    break;
                case "emote": // Emote-formatted messages
                    target.Client.Out.SendMessage(translatedMsg, eChatType.CT_Emote, eChatLoc.CL_SystemWindow);
                    break;
                case "emoteSysOthers": // Emote-formatted messages sent to all other players except the originating player
                ...
                case "help": // System help
                    ...
                    break;
                case "important": // Important system messages
                    target.Client.Out.SendMessage(translatedMsg, eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                    break;
                ...
                case "loot": // Item drops
                    ...
                    break;
                case "merchant": // Merchant messages
                ...
                case "playerDied": // Player died
                    ...
                    break;
                case "playerDiedOthers2": // Player death message sent to other nearby players
                ...
                case "success": // Important command execution messages
                    target.Client.Out.SendMessage(translatedMsg, eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                    break;
                case "sysArea": // System messages sent to a general AoE space
                    Message.SystemToArea(target, translatedMsg, eChatType.CT_System, target);
                    break;
                case "sysOthers": // System messages sent to all nearby players, except the target
        ...
        public static void SendTypeMessage(string type, GamePlayer target, string message)
        {
            ...
            switch (type)
            {
                ...
                case "alliance": // Guild alliance
                    ...
                    break;
                case "battlegroup": // Standard Battle group channel messages
